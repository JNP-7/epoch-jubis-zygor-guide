...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Teldrassil (1-12)",[[
	...
	step//5
		'Sell junk. Buy 3 stacks of arrows. Go to Teldrassil 59.31,41.15
	...
	step//9
		'Start casting hearthstone as soon as you start talking with him.. Use Hearthstone. Go to Teldrassil 54.63,33
		'Talk to Iverron (id:8584)|c
		.'Turn in A Good Friend (id:4495)|c
		.'Accept A Friend in Need (id:3519)|c
	step//10
		Go to Teldrassil 58.66,44.64
		'Talk to Conservator Ilthalaine (id:2079)|c
	...
	step//18
		'Up the ramp. Learn serpent sting. Go to Teldrassil 58.64,40.47
	...
	step//20
		Go to Teldrassil 54.63,38.97
		'Get 7 Hyacinth Mushroom from Grellkin(id:1989) for a quest (id:3521, objective:1)|c
		'Get 8 Fel Moss from Grellkin(id:1989) for a quest (id:3521, objective:3)|c
	step//21
		'After getting the items from the spiders die to death warp to the starting area. Go to Teldrassil 56.66,33.75
	...
	step//31
		'If enough mobs are alive pull a bunch to death warp. Otherwise, walk it out running around the tree from the lakes' side.. Go to Teldrassil 57.59,41.74
	step//32
	...
	step//34
		'Sell junk. Buy 2 stacks of arrows. Go to Teldrassil 59.31,41.11
		'Talk to Keina (id:3589)|c
	step//35
	...
	step//71
		'The are exactly 4 shamans between the 2 camps. Go to Teldrassil 49.44,60.45
	...
	step//72
		'Kill anything on your way pathing around the southern side of the mountain. Avoid the rare Owl if it's around. Interact with the tree to get the quest.. Go to Teldrassil 42.7,76.22
	...
	step//74
		'After looting the herbs, go further north to check if the rare spider is alive. If it's there you can't kill it.. Go to Teldrassil 39.59,65.4
	...
	step//75
		...
		'Die while near the mountains to death warp to Darnassus. Go to Teldrassil 37.32,67.07
	step//76
	...
	step//78
		Go to Darnassus 29.17,45.57
		'Talk to Sister Aquinne (id:7316)|c
		.'Accept The Temple of the Moon (id:2519)|c
	step//79
		Go to Darnassus 36.58,85.85
		'Talk to Priestess A'moora (id:7313)|c
		.'Turn in The Temple of the Moon (id:2519)|c
	...
	step//85
		'Purify the demon essence in the moonwell. Use Demon Essence|c
	...
	step//92
		'Tame a cat. Use Taming Rod. Go to Teldrassil 56.3,71.75
	...
	step//96
		'You can buy level 10 arrows now, a quiver with some extra slots and the level 11 bow if you have spare money. Fill the quiver and buy the bow later if you still don't have the money.. Go to Teldrassil 55.92,59.23
	...
	step//98
		...
		.'Check if Blackmoss is around and kill it if so (kite backwards and keep agro). Don't need to accept the quest yet if you kill it.. Go to Teldrassil 43.07,42.99
	step//99
		'If the spider is not there check [41,25] afterwards. Go to Teldrassil 47.11,26.46
	...
	step//104
		'Fill the vial in the moonwell. Use Amethyst Phial. Go to Teldrassil 38.42,34.11
	...
	step//110
		Go to Darnassus 38.36,21.44
		'Talk to Rellian Greenspyre (id:3517)|c
		.'Turn in Tumors (id:923)|c
	step//111
		Go to Darnassus 38.29,21.26
		'Talk to Rellian Greenspyre (id:3517)|c
		.'Accept Return to Denalan (id:2498)|c
	step//112
		Go to Darnassus 40.34,8.73
		'Talk to Jocaste (id:4146)|c
		.'Turn in Training the Beast (id:6103)|c
		.'Being able to accept this quest is a bug|c
		.'Accept The Hunter's Path (id:6071)|c
	step//113
	...
	step//116
		'Buy a stack of meat for your owl and feed it. Go to Darnassus 65.13,68.53
		.'Talk to Jaeana (id:4169)|c
	step//117
		'Ride the cart to Dolanaar if it is around.. Go to Darnassus 86.53,35.53
	step//118
		Go to Teldrassil 56.69,59.53
		'Buy the level 11 bow if you couldn't before and restock arrows|c
		'Talk to Dazalar (id:3601)|c
		.'Turn in The Hunter's Path (id:6071)|c
	...
	step//120
		Go to Teldrassil 60.87,68.52
		'Talk to Denalan (id:2080)|c
		.'Turn in Return to Denalan (id:2498)|c
		.'Turn in The Glowing Fruit (id:930)|c
		...
		.'Accept Oakenscowl (id:2499)|c
	step//121
		Go to Teldrassil 60.79,68.47
		'Accept The Sprouted Fronds (id:2399)|c
	step//122
		Go to Teldrassil 60.79,68.5
		'Turn in The Sprouted Fronds (id:2399)|c
	step//123
		Go to Teldrassil 53.04,74.53
		.'Get Gargantuan Tumor for a quest (id:2499, objective:1)|c
	step//124
		Go to Teldrassil 60.84,68.48
		'Talk to Denalan (id:2080)|c
		.'Turn in Oakenscowl (id:2499)|c
	step//125
		'Buy level 12 spells if you leveled up. Check if the cart is around to ride it to Darnassus. Otherwise, do some cardio.. Go to Teldrassil 56.21,57.84
	step//126
		Go to Darnassus 70.42,45.27
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Darkshore (12-20)",[[
	...
	step//12
		'Kill crabs for the box's quest. Go to 0,0
	...
	step//27
		...
		'Grind while on the way, prio Striders. Go to Darkshore 44.21,36.33
	...
	step//41
		'Use any temporary consumable buff or guardian thaat you have. You are grinding these for a while. Go to Darkshore 39.01,56.57
	...
	step//43
		'While going south make sure you have at least 5 strider meat and finish killing the rabid bears. Go to Darkshore 37.18,62.26
		'Accept Beached Sea Turtle (id:4722)|c
	step//44
		Go to Darkshore 36.13,70.94
		'Accept Beached Sea Creature (id:4728)|c
	step//45
		Go to Darkshore 43.58,76.32
		'Talk to Onu (id:3616)|c
		.'Turn in Grove of the Ancients (id:952)|c
	step//46
		'Hearth back to Auberdine. Make sure you have 5 strider meat!!!. Use Hearthstone|c
	step//47
	...
	step//50
		...
		'Cook the eggs here andthen head upstairs. Go to Wetlands 10.67,61.51
	...
	step//71
		'Try to kill some Moonstalkers on the way here. Go to Darkshore 44.22,20.75
	...
	step//87
		...
		.'Turn in Beached Sea Turtle (id:4727)|c
	step//88
		'Try to catch the cart that goes south to Ashenvale untill you arrive to Groove of the ancients. Otherwise, time for some cardio, you have rez sickness anyways. Go to Darkshore 40,47.64
	step//89
		Go to Darkshore 43.55,76.31
		'Talk to Onu (id:3616)|c
		.'Turn in Onu (id:948)|c
		.'Accept The Master's Glaive (id:944)|c
		.'Accept Onu is meditating (id:960)|c
	step//90
		'Kill Moonstalkers and bears on your way to the Murloc camp.. Go to Darkshore 36.85,76.64
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Ashenvale & Stonetalon (20-24)",[[
	...
	step//20
		'Fly to Auberdine. Go to Ashenvale 34.4,48.07
	step//21
		Go to Darkshore 39.35,43.43
		'Talk to Terenthis (id:3693)|c
		.'Turn in Escape Through Force (id:994)|c
	step//22
		Go to Darkshore 39.19,43.42
	...
	step//73
		'A couple of antlers here. Then back to the lake. Go to 0,0
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Wetlands & Hillsbrad Pt.1 (24-29)",[[
	...
	step//6
		'>>> SET HEARTHSTONE <<< and buy a flagon of mead. Go to 0,0
	...
	step//14
		'Talk to the engi supplies guy and buy a bronze tube for the Duskwood quest. Go to Wetlands 11.1,58.43
	...
	step//76
		'Now turn 180º and run straight to the last possible room. Jailor Eston should be walking around here. Go to Hillsbrad Foothills 0,0
	...
	step//97
		'When done, go to this house to sell junk. You cna also buy the bronze tube if you don't want that and even some decent armor.. Go to Wetlands 26.09,25.91
	step//98
	...
	step//125
		'First go here and follow the water towards the sea. Kill the 3 Fen creepers (6/10). Go to Wetlands 27.03,39.3
		'Leave your pet in the water. Climb to the top of the ship sing the broken sail and pull Halyndor.. Go to Wetlands 15.96,23.13
	...
	step//141
		...
		'Pet passive, pet stay, send pet to pull all the mobs. Pet passive again so it runs back and despawns. While the mobs follow it, detonate the cart of explisive and get out crossing the bridge. Go to Arathi Highlands 48.83,88.16
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Duskwood (29-31)",[[
	...
	startlevel 80
	step//1
		'Buy weapon skills + the green level 30 quiver. You can even store it in your current quiver until you hit 30. Go to 61.35,89.31
		.'Talk to Thalgus Thunderfist (id:7976)|c
	step//2
		'Train spells. Go to 70.59,83.75
	step//3
	...
	step//10
		'Take the tram and train first aids (book + wool bandages) while waiting/on it. Go to Stormwind City 62.79,34.13
	...
	step//18
		'Buy the Wild steelbloom he has in stock. You need a goldthorn too if you ever find one while questing (off a chest, f.ex.). Go to Stormwind City 69.39,71.68
		.'Talk to Bernard Gump (id:1302)|c
	step//19
	...
	step//46
		...
		'Grab the FP. Go to 38.22,4.1
		'Go to the slope and while running and turning your camera slowly towards your right (towards the tree) spam jump to get up here. You can run through the mountains to Duskwood from here.. Go to 37.6,4.25
	step//47
	...
	step//54
		'Go to Sentinell Hill and grab the FP. It's a good way to get back to Scen later on.. Go to Westfall 56.55,52.54
	...
	step//103
		...
		.'Get 10 Skeleton Finger from Skeletal Horror(id:202) for a quest (id:101, objective:1)|c
	...
	step//116
		...
		.'Accept Juice Delivery (id:159)|c
	step//117
		'This is the last chance to finish the Shambler quest after killing Stalvan. If it's not night time simply abandone the quest.. Go to Duskwood 76.5,35.14
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Wetlands & Hillsbrad Pt.2 (31-34)",[[
	...
	startlevel 80
	step//1
		'Right as you exist the tram. Go to 69.85,50.31
		'Talk to Tinkmaster Overspark (id:7944)|c
		.'Turn in Tinkmaster Overspark (id:2923)|c
	step//2
		'Fly to Menethil Harbor. Go to 55.63,47.87
	step//3
	...
	step//17
		'Go to the pond and interact with the dirt mound. A Murloc will spawn. Kill it. Go to Wetlands 41.81,45.88
	...
	step//36
		'Go to the tower first. There is a rare around here that drops a good AGI + INT belt (Grol'thok). Go to Wetlands 36.32,64.48
	...
	step//38
		...
		'Now for the last named mob. If you leave the area jumping off of it it looks really cool. Go to Wetlands 36.32,64.48
	...
	step//40
		'Go kill Nek'rosh II: the revenge. He was a pusheover. Can pet tank in the main hall. If that's not the case anymore, just kite him to the entrance. Go to Wetlands 50,58
		.'Get Nek'roshes's Head from Chieftain Nek'rosh(id:45262) for a quest (id:26338, objective:1)|c
	step//41
		Go to Wetlands 26.68,59.58
		'Talk to Corporal Mountainview (id:45238)|c
	...
	step//57
		Go to Hillsbrad Foothills 50.34,58.89
		'Talk to Phin Odelic (id:2711)|c
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Duskwood final & 1k needles (34-35)",[[
	...
	step//30
		'As soon as you accept the follow up Hendel and the 2 guards will atck you. Take them off you with your pet and focus in Hendel. Go to Dustwallow Marsh 45.25,24.54
	...
	step//38
		'Time for some leg day. Go to the elevator south of the barrens to get into 1k needles. Go to Thousand Needles 30.54,23.87
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\STV Pt.1 (35-37)",[[
	...
	step//24
		...
		.'Kill 10 Young Panther (id:683)|c
	step//25
	...
	step//26
		'Go east and kil the fighters and the medicine mans for their respective quests. You can AoE down the lumbermill easily, just try to LoS Bookie Herod so he doesn't cast Shadow bolt constantly. Go to Stranglethorn Vale 46.25,11.58
	...
	step//49
		'Go to the troll ruins and begin to gather keys and ears by killing troll.. Go to Stranglethorn Vale 27.65,11.32
	...
	step//60
		'Make your way towards the panthers to the east while getting the crystals from the geologists.. Go to 0,0
		.'Get 8 Tumbled Crystal from Venture Co. Geologist(id:1096) for a quest (id:213, objective:213)|c
	step//61
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Alterac & Arathi Highlands (37-39)",[[
	...
	step//25
		...
		'Fly to Arathi Highlands. Keep an eye out for the Forsaken courier and Fozruk while flying. Chances are if they don't show up they are the beggining of their patrol routes.. Go to Hillsbrad Foothills 49.39,52.35
	step//26
	...
	step//32
		...
		.'Get Cresting Key for a quest (id:651, objective:1)|c
	...
	step//62
		'Use the item from the quest on the hostile water elementals when they are 30-40% HP. Use Calming Air. Go to 897,37.61
	...
	step//90
		...
		.'Get Maiden's Folly Log for a quest (id:662, objective:1)|c
	...
	step//91
		...
		.'Get Some item for a quest (id:662, objective:1)|c
	...
	step//102
		'With some luck you are very close to getting level 40. You probably don't have enough for mount, so just try to learn level 40 spells, specially to use mail.. Go to Arathi Highlands 45.78,46.16
]])
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\STV Pt.2 & Swamp of sorrows (39-43)",[[
	...
	step//50
		'When you are about to kill and Elder Mistvale Gorilla (30-40%) use the helmet to finish them off. You can't get loot so no giblets or fangs. Get this done ASAP. Go to Stranglethorn Vale 33.07,65.41
	...
	step//57
		...
		.'Talk to Corporal Bluth (id:734)|c
	step//58
		'Kill Bhag'thera. Can pet tank or kite around a tree with trap. Becareful with the stealthed panther near the target. Go to Stranglethorn Vale 49.52,24.08
	...
	step//144
		'Go to Bangalash's mound and kill the stealthed panther on the north side. Play rin around the rosie by placing a frost trap (same way you killed the giant in booty bay). Some adds will spawn a 50%. Let your pet take agroo and ignore them. Go to Stranglethorn Vale 37.96,34.82
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Dustwallow Marsh (43)",[[
	...
	step//51
		'Go to Ony's lair and plant the banner. Careful with the spell casters that spawn in the first wave. Super long range. The boss is a pushover.. Go to Dustwallow Marsh 52.15,75.75
	...
	step//54
		'HS back to Theramore (or turn in Tabetha's quests if available, then HS). Use Hearthstone|c
	step//55
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Tanaris Pt.1 (43-45)",[[
	...
	step//28
		'Go to the coast, drink your 3rd water breathing elixir (if you bought one use that one to free bag space) and then swim south while cleaning animals, cleaning oil spillages and recovering underwater parts.. Go to Tanaris 67.1,19.8
	...
	step//48
		...
		.'Get 20 Southsea Pirate Hat for a quest (id:20519, objective:1)|c
	step//49
	...
	step//51
		...
		'Skip this step|c
	step//52
		'Kill Basilisks and collect Raging tempests while making your way to the skeletons with the Fire Rocs at [46,39]. Go to Tanaris 56.31,35.77
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Feralas Pt.1 (45-46)",[[
	...
	step//5
		'You wil have to go to this camp to finish off Naturalists as tehre are not enough in the first one where the cage is. Go to Feralas 69.36,39.69
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Searing Gorge Pt.1 & Tanaris Pt.2 (46-47)",[[
	...
	step//4
		...
		.'Get Crumpled Scroll Fragment from Enraged Rock Elemental(id:2791) for a quest (id:692, objective:1)|c
		.'Get Singed Scroll Fragment from Enraged Rock Elemental(id:2791) for a quest (id:692, objective:1)|c
	step//5
	...
	step//62
		...
		.'Goal: Some objectivea	Escort OOX-17/TN to safety. For a quest (id:648, objective:1)|c
	step//63
		'HS back to Tanaris port. Use Hearthstone|c
	step//64
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Hinterlands (47-48)",[[
	...
	step//14
		'First two cages. Can AoE the camp down. You have explosive from Tanaris too (maybe). Go to The Hinterlands 23.24,58.59
	...
	step//33
		'Go here and start killing the howlers and the owlbeasts. Check the howler spawn, you barely can miss any. Go to The Hinterlands 39.23,45.57
		'Go towards here to kill the far away howler spwan. You should be done with owlbeasts aswell. Go to The Hinterlands 50.58,59.91
	...
	step//38
		'Go to these ruins and gather the 3 horde supply crates in there (check on any DB) the gather the 4th one near the lake (marker). Fully loot the boxes so they respawn, don't be an ass.. Go to The Hinterlands 47.43,37.93
	step//39
	...
	step//53
		...
		.'26502. Goal: Parachute Tested. For a quest (id:26502, objective:1)|c
	step//54
	...
	step//57
		'Long run to the other corner of the map... There is an efigy at the top of thos mound. Use the item here to summon it. Use Wildhammer Torch. Go to The Hinterlands 66.24,53.29
	...
	step//58
		'Check the bottom of this lake for a rare slime with eagle eye. If it's up just kill it for a wand, can vendor or sell on AH (probably no one will ahve money at this level range cause riding skill). Go to The Hinterlands 64.09,61.44
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Searing Gorge Pt.2 (48-49)",[[
	...
	step//7
		...
		.'Accept Singal for Pickup (id:3451)|c
		.'Turn in Singal for Pickup (id:3451)|c
	step//8
	...
	step//18
		...
		'Kill one Steamsmith for a quest item (100% drop rate in Trinity core) tehn move west killing elementals, war golems and spiders. Go to Searing Gorge 39.03,47.94
	...
	step//27
		'While running up the staris, at the crossroads, go north and kill every dwarf on the hallway. Then, do the same in the next room. While doing so read the rest of the step to get ready for the hardest fight on the run.. Go to Searing Gorge 43.68,27.84
	...
	step//51
		'Be careful with the sentries, the yare elite and will kill you. When done killing all the things at the base equip the torch, put pet on stay far away, send it to pull the mobs in the tower then put on passive to drag them out.. Go to Searing Gorge 33.32,53.47
	...
	step//57
		...
		'2 more sentries on top of the twer, drag them out with your pet and send it to mobs away from the bridge.. Go to Searing Gorge 50.28,55.61
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Blasted lands (49-50)",[[
	...
	step//14
		'This quest unlock other Felstone related quests, but skip the follow up. Go to Blasted Lands 67.57,19.16
		'Talk to Watcher Mahar Ba (id:5385)|c
	...
	step//32
		'Use the consumables as you see fit. But remember two things: 1. you have them stacked now due to the turn ins, but you can't stack the ones from the consumables. 2. Save the inellinge one for later when you are Un'Goro, need to engage in the very interesting system of leveling up weapon skills in 2025. Go to Blasted Lands 66.86,18.31
		'Talk to Nina Lightbrew (id:8178)|c
	...
	step//36
		'Learn level 50 spells. Go to 0,0
		.'Talk to Einris Brightspear (id:5515)|c
	step//37
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Azshara & Felwood Pt.1 (50-52)",[[
	...
	step//12
		'Kill any antler you see on your way to the globin for the 2 perfect antlers. No need to finish now.. Go to Azshara 53.5,21.75
	...
	step//42
		'Swim to the helipad at the south eastern corenr of Azshara and use the flare to call the NPC. Use Standard Issue Flare Gun. Go to Azshara 77.81,91.38
	...
	step//59
		...
		.'>>> Make sure you have room for the first jar of each type on you inventory, otherwise, you won't be able to complete the quest since you will lose 1 of the jars <<<. Use Empty Cursed Ooze Jar|c
	...
	step//61
		...
		.'Get 6 Filled Tainted Ooze Jar for a quest (id:4512, objective:1)|c
	step//62
	...
	step//69
		...
		.'Kill 2 Entropic Beast (id:9878) for a quest (id:5156, objective1)|c
		.'Kill 2 Entropic Horror (id:9879) for a quest (id:5156, objective2)|c
	step//70
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Feralas Pt.2 & Plaguelands Pt.1 (52)",[[
	...
	step//9
		'Buy x3 Bait (only need 1, it's just to be sure). Go to Feralas 45.12,25.53
	...
	step//52
		'Inside the house careful while pulling the mobs inside. Go to Western Plaguelands 38.35,54.1
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Un'Goro (52-54)",[[
	...
	step//13
		'As a ghost. Go to Tanaris 53.91,23.38
	...
	step//44
		'Kill Pterrordaxes on the way to the destroyed camp and interact withj the equipment. Go to Un'Goro Crater 38.42,66.07
	...
	step//47
		'Enter the Silithid hive from here. Probably will get the Scenpt Gland. Go to Un'Goro Crater 50.07,80.45
	...
	step//66
		'Can accept the Felwood quest now since quest log is less bloated now. Go to Un'Goro Crater 41.83,2.58
		'Talk to J.D. Collie (id:9117)|c
	...
	step//78
		...
		'Full mana/HP and use the lure when ready. First 2 waves spawn at the side of the entrance of the room so just stay near the crystal. The 3rd wave spawn with the queen near the crystal, so go back to the entrance. The queen can be splitpulled from her guards.. Use Gorish Queen Lure|c
	...
	step//82
		'At the slope, face the topo of the volcano then run and jump constantly to your left until you get to the next level.. Go to Un'Goro Crater 47.35,52.3
		.'Kill and absorb the elementals on your way. Use Yaluni's Totem|c
		'Afterwards just spam jump here to get on the upper level then border the lave lake counter clock wise (you will aggro elemental Ganondorf otherwise). Go to Un'Goro Crater 48.12,50.02
		.'Skip to next step|c
	step//83
	...
	step//96
		'>>> Don't vendor or delete the spell hit trinket for the gnome <<< If FD is nerfed back to being able to be resisted (*puke*) this thing suddenly is useful.. Go to Un'Goro Crater 28.95,77.06
		'Talk to Leakey Cartspark (id:46487)|c
	...
	step//101
		...
		.'Always a Tyrant Devilsaur. Go to Un'Goro Crater 46.61,56.96
	...
	step//141
		'Downstairs to the middle level... Ski pfollow up and vendor the seeds. Go to Darnassus 35.11,8.38
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Felwood Pt.2 & Winterspring Pt.1 (54-56)",[[
	...
	step//22
		'Back to Jaedenar. If you didn't get the red key quest before but do now then do it while finishing the other quest. Unfortunately, it won't worth to do the follow up in this case, you are not going back here again.. Go to Felwood 35.41,58.83
	...
	step//40
		'TODO: If you were able to accept "A Gift for the Spiritseer" from Mau'ari the go turn it in here and accept the foloow up. Go to Winterspring 49.74,45
	step//41
	...
	step//44
		...
		.'Kill 7 Winterfall Den Watcher (id:7440) for a quest (id:5082, objective2)|c
	step//45
	...
	step//47
		'If you are neutral with Timbermaw adn have the totme already turn in the totem quest. If not just wait untill later and skip the step. Use Winterfall Ritual Totem. Go to Felwood 65.5,3.33
	...
	step//51
		...
		'Talk to Nafien (id:15395)|c
		.'Turn in Deadwood of the North (id:6221)|c
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Burning Steppes (56-57)",[[
	...
	step//40
		...
		.'Use the goblin device on broodlings before killing them so they drop a a gem that you can interact with.. Use Draco-Incarcinatrix 900|c
	...
	step//55
		Go to Lakeshire Town Hall 29.82,44.44
	...
	step//70
		'Finish killing the imps here if yuo ahven't yet. Go to Burning Steppes 36.9,59.68
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Winterspring Pt.2 (57-58)",[[
	...
	step//78
		...
		'Drop the meat at the pedestal and kite the tiger towards the pilars to the south-east, then run around them on a frost trap. Use Sacred Frostsaber Meat. Go to Winterspring 49.71,9.76
	...
	step//92
		'Fly to souther Felwood (Emerald Sanctuary). Go to Winterspring 62.33,36.63
	step//93
...
ZygorGuidesViewer:RegisterGuide("Jubi's guide (NE Hunter Project Epoch)\\Plaguelands Pt.2 (58-60)",[[
	...
	step//10
		Go to Lakeshire Town Hall 29.83,44.48
		'Talk to Magistrate Solomon (id:344)|c
	...
	step//29
		'Kill the ghoul, look the other half of the charm and combine them. Use Good Luck Other-Half-Charm. Go to Western Plaguelands 36.83,58.24
		.'Get Good Luck Charm for a quest (id:5903, objective:1)|c
	step//30
	...
	step//55
		...
		.'Kill 5 Frenzied Plaguehound (id:8598) for a quest (id:5544, objective3)|c
	...
	step//80
		'Turn in The Annals of Darrowshire if you are short on XP or just go ding 60 here. Go to Western Plaguelands 43.47,84.88
		'Talk to Nathaniel Dumah (id:11616)|c
